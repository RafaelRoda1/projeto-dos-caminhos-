...
function mostrarResultado() {
  ...
  if (pontuacaoTotal <= 4) {
    ...
    conselho = `${nomeSorteado} já possui uma boa noção e pratica hábitos sustentáveis. Com um pouco mais de atenção aos pequenos detalhes, suas atitudes serão ainda mais transformadoras!`;
  } else {
    nivel = "🟢 Nível: Consciência Exemplar!";
    conselho = `Parabéns a ${nomeSorteado}! Suas atitudes mostram um profundo respeito e cuidado com o meio ambiente. Continue sendo esse exemplo inspirador!`;
  }
